...
public abstract class PooledAttribute<T> extends ItemNBTAttribute.Instance<T> {
    ...
    public static abstract class Generator<T, O extends Generator.Operator<T>> implements ItemNBTAttribute.Instance.Generator<T> {
        public List<Pool<T, O>> pools = new ArrayList<>();
        public O collector;
    ...
    public static class Pool<T, O extends Pool.Operator<T>> {
        public T base;
        public Rolls rolls;
        public List<Pool.Entry<T, O>> entries = new ArrayList<>();
