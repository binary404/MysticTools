...
public class EffectCloudEntity extends Entity {
    ...
    public void setFixedColor(int p_19715_) {
        ...
        this.getEntityData().set(COLOR, p_19715_);
    }
    ...
    public void setParticle(ParticleOptions p_19725_) {
        this.getEntityData().set(PARTICLE, p_19725_);
    }

    protected void setWaiting(boolean p_19731_) {
        this.getEntityData().set(IGNORE_RADIUS, p_19731_);
    }
                                ...
                                if (d3 <= (double) (f * f)) {
                                    ...
                                    for (MobEffectInstance mobeffectinstance1 : list) {
                                        if (this.getOwner() != null) {
                                            if (mobeffectinstance1.getEffect().isBeneficial() && (livingentity.equals(this.getOwner()) || livingentity.isAlliedTo(this.getOwner()))) {
                                                {
                                            ...
                                            } else if (!mobeffectinstance1.getEffect().isBeneficial() && !(livingentity.equals(this.getOwner()) || livingentity.isAlliedTo(this.getOwner()))) {
                                                if (mobeffectinstance1.getEffect().isInstantenous()) {
                                                    mobeffectinstance1.getEffect().applyInstantenousEffect(this, this.getOwner(), livingentity, mobeffectinstance1.getAmplifier(), 0.5D);
                                                } else {
                                                    livingentity.addEffect(new MobEffectInstance(mobeffectinstance1), this);
